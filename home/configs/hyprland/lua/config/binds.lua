...
hl.bind(mainMod .. " + Return",    hl.dsp.exec_cmd(launchPrefix .. "kitty"))
hl.bind(mainMod .. " + E",          hl.dsp.exec_cmd(launchPrefix .. "dolphin"))
hl.bind(mainMod .. " + T",          hl.dsp.exec_cmd(launchPrefix .. "codium"))
hl.bind(mainMod .. " + B",          hl.dsp.exec_cmd(launchPrefix .. "firefox"))
hl.bind("CONTROL + SHIFT + Escape", hl.dsp.exec_cmd(launchPrefix .. "kitty -e btop"))
...
hl.bind(mainMod .. " + SHIFT + TAB", hl.dsp.window.move({ workspace = "special" }))
